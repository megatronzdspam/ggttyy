...
return {
  ...
  usage = {
      user = "!kickme : اخراج از گپ",
      moderator = {
          "!whitelist <enable>/<disable> : فعال و غیر فعال سازی لیست سفید",
          "!whitelist user <user_id> : افزودن کاربر به لیست سفید",
          "!whitelist user <username> : افزودن کاربر به لیست سفید",
          "!whitelist chat : اضافه کردن گپ به لیست سفید",
          "!whitelist delete user <user_id> : حذف کاربر از لیست سفید",
          "!whitelist delete chat : حذف گپ از لیست سفید",
          "!ban user <user_id> : بن کردن کاربر",
          "!ban user <username> : بن کردن کاربر",
          "!ban delete <user_id> : آن بن کردن کاربر",
          "!kick <user_id> : کیک کردن کاربر",
          "!kick <username> : کیک کردن کاربر",
          },
      admin = {
          "!superban user <user_id> : سوپر بن کردن کاربر",
          "!superban user <username> : سوپر بن کردن کاربر",
          "!superban delete <user_id> : حذف سوپر بن",
          },
      },
  patterns = {
    "^[!/](whitelist) (enable)$",
